...
curl http://209.182.218.23:26657/genesis | jq .result.genesis > ~/.regen/config/genesis.json
...
echo "Your node setup is done. You would need some tokens to start your validator. You can get some tokens from the faucet: http://209.182.218.23:8000/faucet/<address>"
echo
echo
